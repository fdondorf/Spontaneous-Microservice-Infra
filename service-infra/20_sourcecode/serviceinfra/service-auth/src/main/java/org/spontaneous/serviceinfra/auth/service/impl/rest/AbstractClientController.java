...
import org.spontaneous.serviceinfra.auth.service.api.rest.AppSystemType;
import org.spontaneous.serviceinfra.auth.service.api.rest.ClientProperties;
import org.spontaneous.serviceinfra.auth.service.api.rest.Header;
import org.spontaneous.serviceinfra.auth.service.api.rest.exception.InvalidApiVersionException;
import org.spontaneous.serviceinfra.auth.service.api.rest.exception.InvalidAppKeyException;
import org.spontaneous.serviceinfra.auth.service.api.rest.exception.InvalidAppSystemException;
import org.spontaneous.serviceinfra.auth.service.api.rest.exception.InvalidAppVersionException;
import org.spontaneous.serviceinfra.auth.service.api.rest.exception.InvalidRequestException;
import org.springframework.beans.factory.annotation.Autowired;

/**
 * Superclass for all client controllers used for the mobile client requests not
 * under oauth control..
 * <p>
...
public class AbstractClientController {
	...
	/**
	 * Check the validity of the input request aka JSON-Syntax. Additional checks
	 * the header data
	 *
